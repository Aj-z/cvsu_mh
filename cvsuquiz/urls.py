...
from .views import (cspear_home_view, BSESS_Quiz, BPED_Quiz, 
                    ...
                    BSE_SS_Quiz,con_home_view, BSMT_QUIZ, BSM_QUIZ, BSN_QUIZ,
                    ceit_home_view,  
...
urlpatterns = [
   ...
   path('CEIT/', BSABE_QUIZ, name='BSABE_quiz'),
   path('CEIT/', BSARCH_QUIZ, name='BSARCH_quiz'),
   path('CEIT/', BSCE_QUIZ, name='BSCE_quiz'),
   path('CEIT/', BSCpE_QUIZ, name='BSCpE_quiz'),
   path('CEIT/', BSCS_QUIZ, name='BSCS_quiz'),
   path('CEIT/', BSEE_QUIZ, name='BSEE_quiz'),
   path('CEIT/', BSINDT_AT_QUIZ, name='BSINDT-AT_quiz'),
   path('CEIT/', BSINDT_ET_QUIZ, name='BSINDT-ET_quiz'),
   path('CEIT/', BSINDT_EX_QUIZ, name='BSINDT-EX_quiz'),
   path('CEIT/', BSIT_QUIZ, name='BSIT_quiz'),
